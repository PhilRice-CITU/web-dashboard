---
title: Overview
description: What the hum.ai edge device is and how it fits the system.
---
...
To get started, install the edge-client on a Raspberry Pi — see
[Installing on a Raspberry Pi](/docs/edge-client/installing).
